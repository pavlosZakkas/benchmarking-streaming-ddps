...
def start_streaming(streaming_interval, messages_per_generator, connection):
  schedule_constant_streaming(streaming_interval, messages_per_generator, stream_purchase, connection)

def start_generator_instances(generators, total_messages, available_time_in_secs, socket, connection):
...
def start(
  ...
  try:
    ...
    start_generator_instances(generators, total_messages, available_time_in_secs, socket, connection)
